...
/**
 * Abstract class representing a CDO algorithm
 *
 * @author Antonio J. Nebro
 */
@SuppressWarnings("serial")
public abstract class AbstractCDO<S, Result> implements Algorithm <Result> {
  ...
  protected abstract void CDOalgorithm(List<S> swarm) ;
