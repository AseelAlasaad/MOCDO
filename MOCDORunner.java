...
/**
 * Class for configuring and running the MOCDO algorithm
 *
 * @author Antonio J. Nebro
 */

public class MOCDORunner extends AbstractAlgorithmRunner {
  /**
  ...
  public static void main(String[] args) throws Exception {
    ...
    var algorithm = new MOCDOBuilder(problem, new SequentialSolutionListEvaluator<>())
